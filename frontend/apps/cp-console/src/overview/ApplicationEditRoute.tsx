...
import IntegrationGuides from '@console/features/applications/components/edit-application/integration-guides/IntegrationGuides';
import ApplicationEditPage from '@console/features/applications/pages/ApplicationEditPage';
