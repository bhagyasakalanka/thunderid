...
describe('useDeleteApplication', () => {
  ...
  // no tokens to revoke and no sessions to detach, and there is no /flow/execute for it to call
  // even if there were. The deletion is the write, and nothing reaches a flow.
