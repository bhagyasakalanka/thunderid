...
const AgentEditRoute = lazy(() =>
  import('@/lib/monaco-setup').then(() => import('./overview/AgentEditRoute')),
);
...
const ApplicationEditRoute = lazy(() =>
  import('@/lib/monaco-setup').then(() => import('./overview/ApplicationEditRoute')),
);
...
const ApplicationTemplateSelectPage = lazy(
  () => import('@/features/applications/pages/ApplicationTemplateSelectPage'),
);
...
const GatewayVariablesListPage = lazy(
  () => import('@/features/gateway-variables/pages/GatewayVariablesListPage'),
);
...
const CreateGatewayVariablePage = lazy(
  () => import('@/features/gateway-variables/pages/CreateGatewayVariablePage'),
);
