      ...
      <>
        ...
        <TabPanel value={activeTab} index={1}>
          <EditPermissionsSettings
            ...
            isReadOnly={role.isReadOnly === true}
          />
        </TabPanel>

        <TabPanel value={activeTab} index={2}>
          <EditAssignmentsSettings roleId={role.id} isReadOnly={role.isReadOnly === true} />
        </TabPanel>

        <TabPanel value={activeTab} index={3}>
          <EditAdvancedSettings
            onDeleteClick={role.isReadOnly === true ? undefined : () => setDeleteDialogOpen(true)}
          />
        </TabPanel>
      </>
