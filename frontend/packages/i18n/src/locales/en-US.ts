...
const translations = {
  ...
  navigation: {
    ...
    'pages.environmentVariables': 'Environment Variables',
  ...
  gatewayVariables: {
    'listing.title': 'Gateway Variables',
    'listing.subtitle': 'Non-secret values substituted into configuration when it is applied to a Data Plane',
    'listing.add': 'Add Variable',
    applyNotice:
      'A change here reaches a Data Plane only when configuration is applied. Use Apply to Data Planes to push it now.',
    'listing.error': 'Failed to load gateway variables',
    'listing.columns.key': 'Key',
    'listing.columns.value': 'Value',
    'listing.columns.description': 'Description',
    'listing.columns.actions': 'Actions',
    'create.title': 'Add Gateway Variable',
    'create.subtitle': 'The key is the declarative placeholder this value resolves when configuration is applied.',
    'create.submit': 'Create Variable',
    'create.success': 'Gateway variable created successfully',
    'create.error': 'Failed to create the gateway variable. Please try again.',
    'edit.title': 'Gateway Variable',
    'edit.subtitle': 'Update the value applied to your Data Planes',
    'edit.error': 'Failed to load the gateway variable',
    'form.key.label': 'Key',
    'form.key.help': 'The declarative placeholder name this variable resolves.',
    'form.key.invalid': 'Use letters, digits and underscores; it must not start with a digit.',
    'form.value.label': 'Value',
    'form.value.help': 'For a list, use a JSON array such as ["https://app.example.com/callback"].',
    'form.description.label': 'Description',
    'update.success': 'Gateway variable updated successfully',
    'update.error': 'Failed to update the gateway variable. Please try again.',
    'delete.title': 'Delete Gateway Variable',
    'delete.message': 'Are you sure you want to delete this gateway variable? This action cannot be undone.',
    'delete.disclaimer':
      'Configuration that references this variable will no longer resolve when applied to a Data Plane.',
    'delete.success': 'Gateway variable deleted successfully',
    'delete.error': 'Failed to delete the gateway variable. Please try again.',
  },
  promotions: {
    'listing.title': 'Promotions',
    'listing.subtitle': 'Promote configuration through your gateways and review every change',
    'listing.error': 'Failed to load gateways',
    'listing.empty': 'No gateways are registered in the gateway manager yet.',
    'listing.pending': 'Pending changes',
    'listing.versionState': 'Latest v{{latest}} · Applied v{{applied}}',
    ...
    'diff.updatedCount': '{{count}} updated',
    'diff.deletedCount': '{{count}} deleted',
    'diff.noChanges': 'No differences. The two versions are identical.',
    'diff.noLineDetail': 'No line-level detail available.',
    'diff.selectChange': 'Include this change',
    'promote.title': 'Promote configuration',
    'promote.description': 'Review what will change in {{target}}, taken from {{source}}.',
    'promote.deselectHint': 'Clear a checkbox to leave that change behind.',
    'promote.applyNow': 'Apply to the target data plane now',
    'promote.confirm': 'Promote {{count}} change',
    'promote.inProgress': 'Promoting...',
    'promote.success': 'Configuration promoted successfully',
    'promote.error': 'Failed to promote configuration. Please try again.',
    ...
    'gateway.createTitle': 'Register gateway',
    'gateway.createSubtitle': 'A gateway is a deployment this organization applies its configuration to.',
    'gateway.name': 'Name',
    'gateway.targetSection': 'Data plane (applied to)',
    'gateway.baseUrl': 'Base URL',
    'gateway.tenantId': 'Control Plane tenant',
    'gateway.tenantIdHelp':
      'The tenant this gateway belongs to. A credential created in that tenant is routed to this gateway.',
    'gateway.secretSection': 'Secret service (optional)',
    'gateway.secretHint':
      'Naming it lets an apply check that every credential the configuration needs is present first.',
    'gateway.token': 'Access token',
    'gateway.clientId': 'Client ID',
    'gateway.clientSecret': 'Client secret',
    'gateway.resource': 'Resource identifier',
    'gateway.resourceHelp': 'The resource server the access token is issued for. Required for client credentials.',
    'gateway.captureNote':
      'Configuration is captured from this Control Plane using your own session, so only the data plane needs credentials.',
    'gateway.insecure': 'Skip TLS certificate verification',
    'gateway.create': 'Register',
    'gateway.createSuccess': 'Gateway registered successfully',
    'gateway.createError': 'Failed to register the gateway. Please try again.',
    'gateway.deleteSuccess': 'Gateway removed',
    'gateway.deleteError': 'Failed to remove the gateway. Please try again.',
    'applyAll.action': 'Apply to Data Planes',
    'applyAll.inProgress': 'Applying...',
    'applyAll.success': 'Applied to {{applied}} gateway(s)',
    'applyAll.partial': 'Applied to {{applied}} gateway(s); {{failed}} could not be applied',
    'applyAll.error': 'Failed to apply to the gateways. Please try again.',
    'variables.manage': 'Manage variables',
    'variables.manageSecrets': 'Manage secrets',
    'variables.missingSecretsTitle': '{{count}} secret is not configured',
    'variables.missingSecretsBody':
    ...
    'variables.missingTitle': '{{count}} variable has no value',
    'variables.missingBody':
      'Applying now leaves these fields empty on the Data Plane, which can break logins. Set them under Gateway Variables first.',
    'detail.manageSecrets': 'Secrets',
    'controlPlane.action': 'To Control Plane',
    'controlPlane.inProgress': 'Updating...',
    'controlPlane.success': 'Control Plane updated from version {{version}}: {{imported}} resources',
    'controlPlane.partial': '{{failed}} of {{total}} resources could not be written',
    'controlPlane.error': 'Failed to update the Control Plane',
    'revert.controlPlanePartial': 'Reverted, but {{failed}} resources could not be written to the Control Plane',
    'secrets.title': 'Secrets',
    'secrets.titleFor': 'Secrets · {{env}}',
    'secrets.subtitle': 'Credentials this gateway needs. They are held by the Data Plane, never by the Control Plane.',
    'secrets.error': 'Failed to load the secrets of this gateway',
    'secrets.empty': 'This gateway has no captured version yet, so there are no credentials to manage.',
    'secrets.notCheckedHint':
      "This is usually this gateway's own target credentials rather than a Data Plane that is down: the same credentials are what an apply authenticates with.",
    'secrets.notChecked':
      "The Data Plane's secret service could not be reached, so which credentials are already set is unknown.",
    'secrets.missingNotice':
      '{{count}} credential is not set. Applying now creates resources whose credentials reject every attempt.',
    'secrets.columns.name': 'Placeholder',
    'secrets.columns.usedBy': 'Used by',
    'secrets.columns.kind': 'Stored as',
    'secrets.columns.status': 'Status',
    'secrets.columns.actions': 'Actions',
    'secrets.notInConfiguration': 'Not in the current version',
    'secrets.hashed': 'Hashed',
    'secrets.hashedHint': 'Only ever compared against what a caller presents, so the Data Plane keeps a one-way hash.',
    'secrets.replayed': 'Value',
    'secrets.replayedHint': 'Sent on to an external service, so the Data Plane has to keep the value itself.',
    'secrets.set': 'Set',
    'secrets.missing': 'Missing',
    'secrets.unknown': 'Unknown',
    'secrets.setValue': 'Set value',
    'secrets.setTitle': 'Set secret',
    'secrets.setHashNotice':
      'This credential is stored as a one-way hash, so it cannot be read back afterwards. Keep a copy of what you enter.',
    'secrets.setValueNotice':
      'This credential is replayed to an external service, so enter exactly the value that service issued.',
    'secrets.valueLabel': 'Value',
    'secrets.saving': 'Saving...',
    'secrets.setSuccess': 'Secret stored on the Data Plane',
    'secrets.setError': 'Failed to store the secret',
    'secrets.regenerate': 'Regenerate',
    'secrets.regenerateTitle': 'Regenerate secret',
    'secrets.regenerating': 'Regenerating...',
    'secrets.regenerateError': 'Failed to regenerate the secret',
    'secrets.regenerateWarning': 'Whatever presents this credential stops working until it is given the new value.',
    'secrets.regenerateUserWarning':
    ...
    'secrets.regenerateAgentWarning': 'The agent stops authenticating until it is configured with the new secret.',
    'secrets.regenerateApplicationWarning':
      'Every client using this application stops authenticating until it is configured with the new secret.',
    'secrets.regeneratedTitle': 'New secret issued',
    'secrets.regeneratedNotice':
      'This value is shown only now. The Data Plane keeps a hash of it, so it cannot be recovered later.',
    'secrets.generateMissing': 'Generate missing ({{count}})',
    'secrets.generateAllTitle': 'Generate missing secrets',
    'secrets.generateAllMessage':
      'A new value is issued for each of these and stored on the Data Plane. You will be shown the values once.',
    'secrets.generateAllManual': '{{count}} credential is issued by an external service and has to be set by hand.',
    'secrets.generateCount': 'Generate {{count}}',
    'secrets.generating': 'Generating...',
    'secrets.generatedTitle': 'Secrets issued',
    'secrets.generatedAll': '{{count}} secret stored on the Data Plane',
    'secrets.generatedPartial': '{{failed}} of {{total}} could not be stored',
    'secrets.generatedNotice':
      'These values are shown only now. Copy them before closing: the Data Plane keeps only hashes.',
    'secrets.copy': 'Copy to clipboard',
    'secrets.copyAll': 'Copy all',
    'secrets.copied': 'Copied',
    'secrets.done': 'Done',
    'capture.action': 'Capture version',
    'capture.inProgress': 'Capturing...',
    'capture.success': 'Configuration captured as a new version',
    'capture.error': 'Failed to capture the configuration. Please try again.',
    'detail.title': 'Gateway',
    'detail.subtitle': 'Configuration version history. The most recent version is at the top.',
    'detail.error': 'Failed to load the version history',
    'detail.empty':
      'This gateway has no configuration versions yet. Capture one from its Control Plane source to get started.',
    'detail.version': 'Version {{seq}}',
    'detail.applied': 'Applied',
    'detail.apply': 'Apply',
    'apply.title': 'Apply configuration',
    'apply.body': 'Version {{version}} will be applied to {{env}}.',
    'apply.noChanges': 'This version matches what is already applied. Nothing would change.',
    'apply.diffError': 'The changes could not be loaded, so this apply cannot be reviewed.',
    'detail.revertToThis': 'Revert to this',
    'detail.revertPrevious': 'Revert to previous',
    'detail.demoteTo': 'Demote to {{target}}',
    'revert.title': 'Revert gateway',
    'revert.message': 'Revert {{env}} to {{target}}?',
    'revert.previousVersion': 'the previous version',
    'revert.versionNumber': 'version {{seq}}',
    'revert.disclaimer': 'History is preserved. Reverting records a new version restoring the older configuration.',
    'revert.applyNow': 'Apply to the data plane now',
    'revert.confirm': 'Revert',
    'revert.inProgress': 'Reverting...',
    'revert.success': 'Gateway reverted successfully',
    'revert.error': 'Failed to revert the gateway. Please try again.',
  },
  groups: {
    // List page
