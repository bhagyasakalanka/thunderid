...
const translations = {
  ...
  environmentVariables: {
    'listing.title': 'Environment Variables',
    ...
    'listing.error': 'Failed to load environment variables',
    'listing.columns.key': 'Key',
    'listing.columns.value': 'Value',
    'listing.columns.description': 'Description',
    'listing.columns.actions': 'Actions',
    'create.title': 'Add Environment Variable',
    ...
    'create.success': 'Environment variable created successfully',
    'create.error': 'Failed to create the environment variable. Please try again.',
    'edit.title': 'Environment Variable',
    'edit.subtitle': 'Update the value applied to your Data Planes',
    'edit.error': 'Failed to load the environment variable',
    'form.key.label': 'Key',
    ...
    'update.success': 'Environment variable updated successfully',
    'update.error': 'Failed to update the environment variable. Please try again.',
    'delete.title': 'Delete Environment Variable',
    'delete.message': 'Are you sure you want to delete this environment variable? This action cannot be undone.',
    'delete.disclaimer':
      'Configuration that references this variable will no longer resolve when applied to a Data Plane.',
    'delete.success': 'Environment variable deleted successfully',
    'delete.error': 'Failed to delete the environment variable. Please try again.',
  },
  promotions: {
    'listing.title': 'Promotions',
    'listing.subtitle': 'Promote configuration through your environments and review every change',
    'listing.error': 'Failed to load environments',
    'listing.empty': 'No environments are registered in the environment manager yet.',
    ...
    'environment.createSubtitle':
      'Environments are ordered by rank, lowest first. Promotion moves configuration to the next rank up.',
    'environment.name': 'Name',
    'environment.rank': 'Rank',
    'environment.rankPlaceholder': 'Defaults to the end of the chain',
    'environment.targetSection': 'Data plane (applied to)',
    'environment.baseUrl': 'Base URL',
    'environment.tenantId': 'Control Plane tenant',
    'environment.tenantIdHelp':
      'The tenant this environment belongs to. A credential created in that tenant is routed to this environment.',
    'environment.secretSection': 'Secret service (optional)',
    'environment.secretHint':
    ...
    'environment.clientSecret': 'Client secret',
    'environment.resource': 'Resource identifier',
    'environment.resourceHelp': 'The resource server the access token is issued for. Required for client credentials.',
    'environment.captureNote':
      'Configuration is captured from this Control Plane using your own session, so only the data plane needs credentials.',
    'environment.insecure': 'Skip TLS certificate verification',
    'environment.create': 'Register',
    'environment.createSuccess': 'Environment registered successfully',
    'environment.createError': 'Failed to register the environment. Please try again.',
    'environment.deleteSuccess': 'Environment removed',
    'environment.deleteError': 'Failed to remove the environment. Please try again.',
    'applyAll.action': 'Apply to Data Planes',
    'applyAll.inProgress': 'Applying...',
    'applyAll.success': 'Applied to {{applied}} environment(s)',
    'applyAll.partial': 'Applied to {{applied}} environment(s); {{failed}} could not be applied',
    'applyAll.error': 'Failed to apply to the environments. Please try again.',
    ...
    'secrets.error': 'Failed to load the secrets of this environment',
    'secrets.empty': 'This environment has no captured version yet, so there are no credentials to manage.',
    ...
    'revert.title': 'Revert environment',
    ...
    'revert.success': 'Environment reverted successfully',
    'revert.error': 'Failed to revert the environment. Please try again.',
  },
  groups: {
    // List page
