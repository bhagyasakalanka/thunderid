...
func (st *store) CreateOAuthProfile(ctx context.Context, entityID string,
	...
	_, err = dbClient.ExecuteContext(ctx, queryCreateOAuthProfile, entityID, profileJSON,
		deployment.Resolve(ctx, st.deploymentID))
	if err != nil {
...
func (st *store) GetInboundClientByEntityID(ctx context.Context, entityID string) (*inboundmodel.InboundClient, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetInboundClientByEntityID, entityID,
		deployment.Resolve(ctx, st.deploymentID))
	if err != nil {
...
func (st *store) GetOAuthProfileByEntityID(ctx context.Context, entityID string) (*providers.OAuthProfile, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetOAuthProfileByEntityID, entityID,
		deployment.Resolve(ctx, st.deploymentID))
	if err != nil {
		return nil, fmt.Errorf("failed to execute query: %w", err)
	}
...
func (st *store) GetInboundClientList(ctx context.Context, limit int) ([]providers.InboundClient, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetInboundClientList,
		deployment.Resolve(ctx, st.deploymentID), limit)
	if err != nil {
		return nil, fmt.Errorf("failed to execute query: %w", err)
	}
...
func (st *store) DeleteInboundClient(ctx context.Context, entityID string) error {
	...
	_, err = dbClient.ExecuteContext(ctx, queryDeleteInboundClientByEntityID, entityID,
		deployment.Resolve(ctx, st.deploymentID))
	if err != nil {
...
func (st *store) DeleteOAuthProfile(ctx context.Context, entityID string) error {
	...
	_, err = dbClient.ExecuteContext(ctx, queryDeleteOAuthProfileByEntityID, entityID,
		deployment.Resolve(ctx, st.deploymentID))
	if err != nil {
