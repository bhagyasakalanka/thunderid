...
// GatewayConfig holds how many data planes this deployment administers.
//
// It is here rather than in the engine's server configuration because only a deployment that
// administers data planes reads it, and the engine serves deployments that administer none.
type GatewayConfig struct {
	// MaxGateways bounds how many data planes a deployment may register.
	//
