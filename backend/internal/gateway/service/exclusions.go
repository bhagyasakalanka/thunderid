...
// the target gateway and reapplied by default, and selecting the resource again clears it.
...
// rememberSelection stores the gateway's exclusions when they changed.
func (s *Service) rememberSelection(ctx context.Context, env model.Gateway, d diff.Diff,
