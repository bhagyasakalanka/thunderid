...
type declaredGateway struct {
	...
	// No key: the control plane issues one when it first adopts this file, and keeps it across
	// later reads. A key in a declaration would be a data plane credential in source control.
