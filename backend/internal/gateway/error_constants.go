...
var (
	...
	// ErrorDataPlaneAlreadyRegistered is returned when a gateway already answers at that address.
	...
	ErrorGatewayConnectionRequired = tidcommon.ServiceError{
		...
		Error: tidcommon.I18nMessage{
			...
			DefaultValue: "A base URL and a data plane ID are required to reach the gateway",
		},
	}
	...
	ErrorNothingToUpdate = tidcommon.ServiceError{
		...
		Error: tidcommon.I18nMessage{
			...
			DefaultValue: "The request changes nothing: name, baseUrl or caCertificate is required",
		},
	}
