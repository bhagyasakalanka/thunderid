...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutListCount_AddsCounts() {
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(3, nil)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutListCount_DBStoreError() {
	...
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(0, testErr)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutListCount_FileStoreCountError() {
	...
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(0, testErr)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutListCount_EmptyStores() {
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(0, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(0, nil)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutList_Pagination() {
	...
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(2, nil)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutList_LimitExceeded() {
	...
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(1001, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(0, nil)
...
func (suite *CompositeLayoutStoreTestSuite) TestGetLayoutList_FileLayoutsListError() {
	...
	suite.mockDBStore.On("GetLayoutListCount", mock.Anything).Return(1, nil)
	suite.mockFileStore.On("GetLayoutListCount", mock.Anything).Return(2, nil)
...
func (suite *CompositeLayoutStoreTestSuite) TestIsLayoutDeclarative_True() {
	...
	isDeclarative := suite.store.IsLayoutDeclarative(context.Background(), "layout1")
