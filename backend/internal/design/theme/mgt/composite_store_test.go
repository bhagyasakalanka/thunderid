...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeListCount_AddsCounts() {
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(3, nil)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeListCount_DBStoreError() {
	...
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(0, testErr)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeListCount_FileStoreCountError() {
	...
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(0, testErr)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeListCount_EmptyStores() {
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(0, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(0, nil)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeList_Pagination() {
	...
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(2, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(2, nil)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeList_LimitExceeded() {
	...
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(1001, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(0, nil)
...
func (suite *CompositeThemeStoreTestSuite) TestGetThemeList_FileThemesListError() {
	...
	suite.mockDBStore.On("GetThemeListCount", mock.Anything).Return(1, nil)
	suite.mockFileStore.On("GetThemeListCount", mock.Anything).Return(2, nil)
...
func (suite *CompositeThemeStoreTestSuite) TestIsThemeDeclarative_True() {
	...
	isDeclarative := suite.store.IsThemeDeclarative(context.Background(), "theme1")
