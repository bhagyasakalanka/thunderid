...
func (s *groupStore) GetGroupListCount(ctx context.Context) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, QueryGetGroupListCount, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetGroupList(ctx context.Context, limit, offset int) ([]GroupBasicDAO, error) {
	...
	results, err := dbClient.QueryContext(ctx, QueryGetGroupList, limit, offset,
...
func (s *groupStore) GetGroupListCountByOUIDs(ctx context.Context, ouIDs []string) (int, error) {
	...
	query, args := buildGetGroupsCountByOUIDsQuery(ouIDs, deployment.Resolve(ctx, s.deploymentID))
...
func (s *groupStore) GetGroupListByOUIDs(
	...
	query, args := buildGetGroupsByOUIDsQuery(ouIDs, limit, offset, deployment.Resolve(ctx, s.deploymentID))
...
func (s *groupStore) CreateGroup(ctx context.Context, group GroupDAO) error {
	...
	err = addMembersToGroup(ctx, dbClient, group.ID, group.Members, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return err
	}
...
func (s *groupStore) GetGroup(ctx context.Context, id string) (GroupDAO, error) {
	...
	results, err := dbClient.QueryContext(ctx, QueryGetGroupByID, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetGroupMembers(ctx context.Context, groupID string, limit, offset int) ([]Member, error) {
	...
	results, err := dbClient.QueryContext(ctx, QueryGetGroupMembers, groupID, limit, offset,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetGroupMemberCount(ctx context.Context, groupID string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, QueryGetGroupMemberCount, groupID,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) DeleteGroup(ctx context.Context, id string) error {
	...
	_, err = dbClient.ExecuteContext(ctx, QueryDeleteGroupMembers, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return fmt.Errorf("failed to delete group members: %w", err)
	}

	result, err := dbClient.ExecuteContext(ctx, QueryDeleteGroup, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return fmt.Errorf("failed to execute query: %w", err)
	}
...
func (s *groupStore) ValidateGroupIDs(ctx context.Context, groupIDs []string) ([]string, error) {
	...
	query, args, err := buildBulkGroupExistsQueryFunc(groupIDs, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) CheckGroupNameConflictForCreate(
	...
	return checkGroupNameConflictForCreate(ctx, dbClient, name, oUID, deployment.Resolve(ctx, s.deploymentID))
}
...
func (s *groupStore) CheckGroupNameConflictForUpdate(
	...
	return checkGroupNameConflictForUpdate(ctx, dbClient, name, oUID, groupID, deployment.Resolve(ctx, s.deploymentID))
}
...
func (s *groupStore) GetGroupsByOrganizationUnitCount(ctx context.Context, oUID string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(
		ctx, QueryGetGroupsByOrganizationUnitCount, oUID, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetGroupsByOrganizationUnit(
	...
	results, err := dbClient.QueryContext(
		ctx, QueryGetGroupsByOrganizationUnit, oUID, limit, offset, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) AddGroupMembers(ctx context.Context, groupID string, members []Member) error {
	...
	return addMembersToGroup(ctx, dbClient, groupID, members, deployment.Resolve(ctx, s.deploymentID))
}
...
func (s *groupStore) RemoveGroupMembers(ctx context.Context, groupID string, members []Member) error {
	...
	for _, member := range members {
		_, err := dbClient.ExecuteContext(
			...
			groupID, member.Type, member.ID, deployment.Resolve(ctx, s.deploymentID),
		)
		if err != nil {
...
func (s *groupStore) DeleteMembershipsByMember(
	...
	rowsAffected, err := dbClient.ExecuteContext(
		ctx, QueryDeleteGroupMembershipsByMember, memberType, memberID, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetGroupsByIDs(ctx context.Context, groupIDs []string) ([]GroupBasicDAO, error) {
	...
	for start := 0; start < len(groupIDs); start += batchSize {
		...
		query, args, err := buildGetGroupsByIDsQuery(chunk, deployment.Resolve(ctx, s.deploymentID))
		if err != nil {
...
func (s *groupStore) GetTransitiveGroupsForEntity(
	...
	results, err := dbClient.QueryContext(ctx, QueryGetTransitiveGroupsForMember, entityID,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *groupStore) GetDirectGroupParents(ctx context.Context, groupIDs []string) ([]string, error) {
	...
	query, args := buildGetDirectGroupParentsQuery(groupIDs, deployment.Resolve(ctx, s.deploymentID))
	results, err := dbClient.QueryContext(ctx, query, args...)
	if err != nil {
