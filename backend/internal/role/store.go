...
func (s *roleStore) GetRoleListCount(ctx context.Context) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetRoleListCount, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleList(ctx context.Context, limit, offset int) ([]Role, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleList, limit, offset, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleListCountByOUID(ctx context.Context, ouID string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetRoleListCountByOUID, ouID, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return 0, fmt.Errorf("failed to execute count query: %w", err)
	}
...
func (s *roleStore) GetRoleListByOUID(ctx context.Context, ouID string, limit, offset int) ([]Role, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleListByOUID, ouID, limit, offset, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return nil, fmt.Errorf("failed to execute role list query: %w", err)
	}
...
func (s *roleStore) CreateRole(ctx context.Context, id string, role RoleCreationDetail) error {
	...
	if err := addPermissionsToRole(ctx, dbClient, id, role.Permissions, deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}

	if err := addAssignmentsToRole(ctx, dbClient, id, role.Assignments, deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}
...
func (s *roleStore) GetRole(ctx context.Context, id string) (RoleWithPermissions, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleByID, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) IsRoleExist(ctx context.Context, id string) (bool, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryCheckRoleExists, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleAssignments(ctx context.Context, id string, limit, offset int) ([]RoleAssignment, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleAssignments, id, limit, offset, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleAssignmentsByType(
	...
	results, err := dbClient.QueryContext(
		ctx, queryGetRoleAssignmentsByType, id, limit, offset, deployment.Resolve(ctx, s.deploymentID), assigneeType)
	if err != nil {
		return nil, fmt.Errorf("failed to get role assignments: %w", err)
	}
...
func (s *roleStore) GetRoleAssignmentsCount(ctx context.Context, id string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetRoleAssignmentsCount, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleAssignmentsCountByType(ctx context.Context, id string, assigneeType string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(
		ctx, queryGetRoleAssignmentsCountByType, id, deployment.Resolve(ctx, s.deploymentID), assigneeType)
	if err != nil {
		return 0, fmt.Errorf("failed to get role assignments count: %w", err)
	}
...
func (s *roleStore) UpdateRole(ctx context.Context, id string, role RoleUpdateDetail) error {
	...
	if err := updateRolePermissions(ctx, dbClient, id, role.Permissions, deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}
...
func (s *roleStore) DeleteRole(ctx context.Context, id string) error {
	...
	rowsAffected, err := dbClient.ExecuteContext(ctx, queryDeleteRole, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return fmt.Errorf("failed to execute query: %w", err)
	}
...
func (s *roleStore) DeleteAssignmentsByRoleID(ctx context.Context, id string) error {
	...
	_, err = dbClient.ExecuteContext(ctx, queryDeleteAllRoleAssignments, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) DeleteAssignmentsByAssignee(
	...
	rowsAffected, err := dbClient.ExecuteContext(
		ctx, queryDeleteRoleAssignmentsByAssignee, assigneeType, assigneeID, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) AddAssignments(ctx context.Context, id string, assignments []RoleAssignment) error {
	...
	return addAssignmentsToRole(ctx, dbClient, id, assignments, deployment.Resolve(ctx, s.deploymentID))
}
...
func (s *roleStore) RemoveAssignments(ctx context.Context, id string, assignments []RoleAssignment) error {
	...
	for _, assignment := range assignments {
		_, err := dbClient.ExecuteContext(
			ctx, queryDeleteRoleAssignmentsByIDs, id, assignment.Type, assignment.ID, deployment.Resolve(ctx, s.deploymentID))
		if err != nil {
...
func (s *roleStore) getRolePermissions(
	...
	results, err := dbClient.QueryContext(ctx, queryGetRolePermissions, id, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) CheckRoleNameExists(ctx context.Context, ouID, name string) (bool, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryCheckRoleNameExists, ouID, name, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) CheckRoleNameExistsExcludingID(
	...
	results, err := dbClient.QueryContext(
		ctx, queryCheckRoleNameExistsExcludingID, ouID, name, excludeRoleID, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return false, fmt.Errorf("failed to check role name existence: %w", err)
	}
...
func (s *roleStore) GetAuthorizedPermissionsByResourceServer(
	...
	query, args := buildAuthorizedPermissionsQuery(
		entityID, groupIDs, resourceServerID, requestedPermissions, deployment.Resolve(ctx, s.deploymentID))
...
func (s *roleStore) GetUserRoles(
	...
	query, args := buildUserRolesQuery(entityID, groupIDs, deployment.Resolve(ctx, s.deploymentID))
...
func (s *roleStore) GetEntityRoleIDs(
	...
	query, args := buildEntityRoleIDsQuery(entityID, groupIDs, deployment.Resolve(ctx, s.deploymentID))
