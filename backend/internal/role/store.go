...
func (s *roleStore) GetRoleListCountByOUID(ctx context.Context, ouID string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetRoleListCountByOUID, ouID,
...
func (s *roleStore) GetRoleListByOUID(ctx context.Context, ouID string, limit, offset int) ([]Role, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleListByOUID, ouID, limit, offset,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
		return nil, fmt.Errorf("failed to execute role list query: %w", err)
	}
...
func (s *roleStore) CreateRole(ctx context.Context, id string, role RoleCreationDetail) error {
	...
	if err := addPermissionsToRole(ctx, dbClient, id, role.Permissions,
		deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}

	if err := addAssignmentsToRole(ctx, dbClient, id, role.Assignments,
		deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}
...
func (s *roleStore) GetRoleAssignments(ctx context.Context, id string, limit, offset int) ([]RoleAssignment, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetRoleAssignments, id, limit, offset,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetRoleAssignmentsCount(ctx context.Context, id string) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetRoleAssignmentsCount, id,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) UpdateRole(ctx context.Context, id string, role RoleUpdateDetail) error {
	...
	if err := updateRolePermissions(ctx, dbClient, id, role.Permissions,
		deployment.Resolve(ctx, s.deploymentID)); err != nil {
		return err
	}
...
func (s *roleStore) GetReferencedPermissions(ctx context.Context) ([]ResourcePermissions, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetReferencedPermissions, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) DeleteRolePermission(
	...
	rowsAffected, err := dbClient.ExecuteContext(
		ctx, queryDeleteRolePermissionByValue, resourceServerID, permission, deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) RemoveAssignments(ctx context.Context, id string, assignments []RoleAssignment) error {
	...
	for _, assignment := range assignments {
		_, err := dbClient.ExecuteContext(
			ctx, queryDeleteRoleAssignmentsByIDs, id, assignment.Type, assignment.ID,
			deployment.Resolve(ctx, s.deploymentID))
		if err != nil {
...
func (s *roleStore) CheckRoleNameExists(ctx context.Context, ouID, name string) (bool, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryCheckRoleNameExists, ouID, name,
		deployment.Resolve(ctx, s.deploymentID))
	if err != nil {
...
func (s *roleStore) GetAllPermissionsForAssignees(
	...
	query, args := buildAllPermissionsForAssigneesQuery(entityID, groupIDs, deployment.Resolve(ctx, s.deploymentID))
